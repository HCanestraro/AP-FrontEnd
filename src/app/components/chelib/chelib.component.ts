...
import { DatastoreService } from './../../services/datastore-service.service';
import { MyModel } from 'src/app/models/mymodel';
...
export class ChelibComponent implements OnInit {
  ...
  async ngOnInit() {
    this.entities = await this.datastoreService.getEntities('MyKind');
  }
}
